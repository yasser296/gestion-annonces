      ...
      <nav className="navbar-glass sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo moderne */}
            <Link to="/" state={{ from: location.pathname }} className="flex items-center space-x-3">
        ...
        {showMenu && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
              <Link to="/" state={{ from: location.pathname }} className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                Accueil
              </Link>
              {isCategoryPage && (
                <Link to="/categories" state={{ from: location.pathname }} className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                  Catégorie
                </Link>
              )}
              {user ? (
                <>
                  <Link to={`/profil/${user.id}`} state={{ from: location.pathname }} className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                    Mon profil
                  </Link>
                  <Link to="/mes-annonces" state={{ from: location.pathname }} className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                    Mes annonces
                  </Link>
                  <button
                    onClick={handleCreateAnnonceClick}
